...
public class A6_Calendars {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000L);
		//cuando se quieres seleccionar un elemento que tiene una clase separada por comas
		//se deben de ir uniendo con los puntos y se debe acceder a traves de cssSelector
		driver.findElement(By.cssSelector(".ui-datepicker-week-end.ui-datepicker-current-day")).click();

		
		//hay ocasiones en los que isEnabled no funciona (siempre es true, a pesar que
		//se vea desactivado en front, pues cuando se da click "se activa" lo que pasa realmente
