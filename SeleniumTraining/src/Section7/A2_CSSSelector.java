...
//Los selectores por css son 10 veces más rapidos que los de xpath
//Con CSS no es necesario incluir el tagName... --> es valido --> [class='identify first'] al contrario con 
//				xpath sería //*[@class='identify first']
	public static void main(String[] args) {
			...
			//Lo anterior también se puede hacer con el id By.cssSelector("#Login"), si se 
			//tiene una clase con varios identificadores por ejemplo class="iden1 iden2" se pondría .iden1.iden2
	}
