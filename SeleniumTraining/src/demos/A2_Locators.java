...
//Suponiendo el escenario en el que se automaticen 50 diferentes páginas y que de repente en la numero 48 marca un error
...
//- para css seria $("")
		...
		//CSS
		//La sintaxis es		   : tagName[attribute = 'value']	(tambien se puede quitar el tagName ó tagName#valorId ó tagName.valorClass
		// Si un elemento cambia se puede usar la expresion contains (que por ejemplo un selector class cambie de username123 a username456)
		//					- tagName[attribute*='value']					--> input[class*='username']
		driver.findElement(By.cssSelector("#passwordInput")).sendKeys("test");
		//se puede obtener el texto de si la contraseña ha sido incorrecta y desplegar en consola
